...
const AllPlaylistsPage = () => {
    ...
    // ESC para salir del modo creación
    useEffect(() => {
        ...
        <main className="rounded-md overflow-hidden h-full bg-gradient-to-b from-lapsus-1200/35 to-lapsus-900">
            <div className="p-6 text-white relative">
                ...
                <button
                    ...
                    className="absolute top-6 right-6 #6A1E55 hover:#6A1E55 transition-colors text-white rounded-full p-2"
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
                    {/* Tarjeta de creación de playlist */}
                    {creating && (
                        <div className="#6A1E55 rounded-lg p-3 shadow-md relative overflow-hidden">
                    ...
                    {playlists.map((playlist) => (
                        ...
                        >
                            ...
                            <div className="relative z-10">
                                ...
                                <p className="text-sm text-lapsus-300 line-clamp-2">
