...
const ProfilePage = () => {
  ...
  useEffect(() => {
    const fetchUser = async () => {
      try {
        const { data } = await axiosInstance.get(`${BASE_URL}/users/me`, {
    ...
    const fetchPlaylists = async () => {
      try {
        const { data } = await axiosInstance.get(`${BASE_URL}/playlists`, {
          withCredentials: true,
        });
        setPlaylists(data);
      } catch (err) {
  ...
  const handleCoverUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      const res = await axiosInstance.post(`${BASE_URL}/users/upload-cover`, formData, {
        withCredentials: true,
  ...
  const handleAvatarUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      const res = await axiosInstance.post(`${BASE_URL}/users/upload-avatar`, formData, {
        withCredentials: true,
        headers: { "Content-Type": "multipart/form-data" },
      });
  ...
  const handleSave = async () => {
    try {
      await axiosInstance.put(`${BASE_URL}/users/update`, { nickname, bio, tags }, {
        withCredentials: true,
      });
  ...
  const handleCreatePost = async () => {
    ...
    try {
      await axiosInstance.post(`${BASE_URL}/posts`, formData, {
        withCredentials: true,
        headers: { "Content-Type": "multipart/form-data" },
      });
      setPostDescription("");
