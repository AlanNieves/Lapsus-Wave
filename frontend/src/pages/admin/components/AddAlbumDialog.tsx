	...
	return (
		<Dialog open={albumDialogOpen} onOpenChange={setAlbumDialogOpen}>
			<DialogTrigger asChild>
				<Button className='bg-lapsus-1100/20 hover:bg-lapsus-1100/20 text-lapsus-500'>
					<Plus className='mr-2 h-4 w-4' />
					Add Album
				</Button>
			</DialogTrigger>
			<DialogContent className='bg-gradient-to-bl from-lapsus-1200/10 to-lapsus-1000/40 border-lapsus-800/50'>
				<DialogHeader>
				...
				<div className='space-y-4 py-4'>
					...
					<div className='space-y-2'>
						...
						<Input
							...
							className='bg-transparent border-lapsus-800'
