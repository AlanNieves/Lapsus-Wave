...
const AddSongDialog = () => {
	...
	return (
		<Dialog open={songDialogOpen} onOpenChange={setSongDialogOpen}>
			...
			<DialogContent className='bg-gradient-to-b from-black border-zinc-700 max-h-[80vh] overflow-auto'>
				<DialogHeader>
						...
						<div className='text-center'>
							{files.image ? (
								<div className='space-y-2'>
									...
									<div className='text-xs text-lapsus-500'>{files.image.name.slice(0, 20)}</div>
								</div>
							) : (
								<>
