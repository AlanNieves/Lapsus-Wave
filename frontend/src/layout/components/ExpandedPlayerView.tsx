...
export const ExpandedPlayerView = () => {
  ...
  return (
    <>
      <Head>
        <link href="https://fonts.googleapis.com/css2?family=Rubik+Dirt&family=Stick+No+Bills:wght@800&display=swap" rel="stylesheet" />
      </Head>
      ...
      <AnimatePresence>
        {isExpandedViewOpen && (
          ...
          >
            ...
            {/* Texto "LAPSUS" con estilo graffiti mexicano */}
            <motion.div
            ...
            >
              <motion.h1 
                className="text-[16rem] font-black tracking-tighter"
                style={{
                  ...
                  textShadow: `
                    ...
                    6px 6px 0px rgba(164, 77, 121, 0.3)`
                }}
                animate={{
                  backgroundPosition: ['0% 0%', '100% 100%'],
                  textShadow: [
                    '4px 4px 0px rgba(0,0,0,0.2), 6px 6px 0px rgba(164, 77, 121, 0.3)',
                    '5px 5px 0px rgba(0,0,0,0.2), 8px 8px 0px rgba(164, 77, 121, 0.4)'
                  ]
                }}
                transition={{
                  duration: 8,
